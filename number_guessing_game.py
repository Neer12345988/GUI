...
ok_btn = Button(root, text="OK", bg="#c7c3c3", fg="#000000", width=5, font=("Arial", 16, "bold"))
...
number_btn = Button(root, text="GUESS", bg="#c7c3c3", fg="#000000", width=8, font=("Arial", 16, "bold"))
